            ...
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        class="border p-3 w-full rounded-lg  bg-white @error('name') border-red-500  @enderror"
                        value="{{ old('name') }}"
                    />
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        class="border p-3 w-full rounded-lg  bg-white @error('password_confirmation') border-red-500  @enderror"
                    />
